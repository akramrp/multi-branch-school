				...
				<div class="row">
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="register_no" value="<?=set_value('register_no', $register_id)?>" readonly />
				...
				<div class="row mb-md">
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								...
								echo form_dropdown("class_id", $arrayClass, set_value('class_id'), "class='form-control' id='class_id' onchange='getSectionByClass(this.value, 0); getRollByClass(this.value); '
								data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity' ");
							?>
					...
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="roll" id="roll_num" value="<?=set_value('roll')?>" readonly />
				...
				<div class="row">
					<div class="col-md-4 mb-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="pen" value="<?=set_value('pen')?>" />
						</div>
					</div>
					<div class="col-md-4 mb-sm">
						<div class="form-group">
